...
var grammar = {
    ...
    {"name": "expression$ebnf$1$subexpression$1", "symbols": [(lexer.has("word") ? {type: "word"} : word), "expression"]},
    {"name": "expression$ebnf$1", "symbols": ["expression$ebnf$1$subexpression$1"]},
    {"name": "expression$ebnf$1$subexpression$2", "symbols": [(lexer.has("word") ? {type: "word"} : word), "expression"]},
    ...
    {"name": "expression", "symbols": ["expression", "expression$ebnf$1"], "postprocess":  (data) => ( { type:'fun-call',  fun:data[1], 
        args: { args: [ data[0], data[2] ] } } ) },
    {"name": "expression$ebnf$2", "symbols": [(lexer.has("word") ? {type: "word"} : word)], "postprocess": id},
    {"name": "expression$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "expression$ebnf$3", "symbols": []},
    {"name": "expression$ebnf$3$subexpression$1", "symbols": [(lexer.has("comma") ? {type: "comma"} : comma), (lexer.has("word") ? {type: "word"} : word)]},
    {"name": "expression$ebnf$3", "symbols": ["expression$ebnf$3", "expression$ebnf$3$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "expression", "symbols": [(lexer.has("lparen") ? {type: "lparen"} : lparen), "expression$ebnf$2", "expression$ebnf$3", (lexer.has("rparen") ? {type: "rparen"} : rparen), (lexer.has("thinarrow") ? {type: "thinarrow"} : thinarrow), "expression"], "postprocess":  (data) => ( { type:'lambda', ident: data[0],func:data[1], 
    ...
    {"name": "mathresult", "symbols": ["l1ops"], "postprocess": (data) =>( { type:'operand', value : data[0].value } )},
    ...
    {"name": "l7ops", "symbols": ["l7ops", "l2operator", "l8ops"], "postprocess": (data) =>( { type:'op', value: { lhs: data[0].value, op: data[1].value, rhs: data[2].value } } )},
    {"name": "l7ops", "symbols": ["l8ops"], "postprocess": (data) =>( { type:'operand', value : data[0].value } )},
    {"name": "l8ops", "symbols": ["l8ops", "l1operator", "operand"], "postprocess": (data) =>( { type:'dot-op', value: { lhs: data[0].value, op: data[1].value, rhs: data[2].value } } )},
    {"name": "l8ops", "symbols": ["operand"], "postprocess": (data) =>( { type:'operand', value : data[0].value } )},
