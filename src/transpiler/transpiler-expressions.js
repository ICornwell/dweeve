...
codeGenFor['member'] = (context, code) => { 
    context.compiler({parentType: 'member', node: context.node.key, compiler:context.compiler}, code)
    code.addCode(': ')
    context.compiler({parentType: 'member', node: context.node.value, compiler:context.compiler}, code)
}
